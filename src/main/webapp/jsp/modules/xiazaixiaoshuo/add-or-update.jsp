...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑下载小说</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>下载小说管理</span></li>
								<li class="breadcrumb-item active"><span>编辑下载小说</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">下载小说信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>小说分类</label>
										<input id="xiaoshuofenlei" name="xiaoshuofenlei" class="form-control" placeholder="小说分类">
									</div>
									<div class="form-group col-md-6">
										<label>读者账号</label>
										<input id="duzhezhanghao" name="duzhezhanghao" class="form-control" placeholder="读者账号">
									</div>
									<div class="form-group col-md-6">
										<label>姓名</label>
									...
									<div class="form-group col-md-6">
										<label>小说文件</label>
										<div>
										<div class="upload">选择文件<input name="file" type="file" class="form-control-file" id="xiaoshuowenjianupload"></div>
										<label id="xiaoshuowenjianFileName"></label>
										<input name="xiaoshuowenjian" id="xiaoshuowenjian-input" type="hidden">
										</div>
									</div>
									<div class="form-group col-md-6">
										<label>发布日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xiazaixiaoshuo/info/" + id,
		...
		// 文件上传
		function upload(){
			$('#xiaoshuowenjianupload').fileupload({
				url: baseUrl + 'file/upload',
				headers:{ token: window.sessionStorage.getItem("token")},
				dataType: 'json',
				done: function (e, data) {							
					document.getElementById('xiaoshuowenjian-input').setAttribute('value',baseUrl+'file/download?fileName='+data.result.file);
					if(document.getElementById('xiaoshuowenjianFileName') != null){
						document.getElementById('xiaoshuowenjianFileName').innerHTML = "上传成功!";
					}		
					$("#xiaoshuowenjianImg").attr("src",data.result.file);												
				}
			});
		}  
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("xiazaixiaoshuo/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xiazaixiaoshuo/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("xiazaixiaoshuo"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#xiaoshuofenlei").val(ruleForm.xiaoshuofenlei);	
			$("#duzhezhanghao").val(ruleForm.duzhezhanghao);	
			$("#xingming").val(ruleForm.xingming);	
			$("#xiaoshuowenjian-input").val(ruleForm.xiaoshuowenjian);
			$("#xiaoshuowenjianFileName").html(ruleForm.xiaoshuowenjian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					$("#xiaoshuofenlei").val(res.data.xiaoshuofenlei);
					}
					if(res.data != null && res.data != '' && res.data.duzhezhanghao != null && res.data.duzhezhanghao != ''){

					$("#duzhezhanghao").val(res.data.duzhezhanghao);
					}
					if(res.data != null && res.data != '' && res.data.xingming != null && res.data.xingming != ''){

					$("#xingming").val(res.data.xingming);
					}
					if(res.data != null && res.data != '' && res.data.xiaoshuowenjian != null && res.data.xiaoshuowenjian != ''){

					$("#xiaoshuowenjian-input").val(res.data.xiaoshuowenjian);
					$('#xiaoshuowenjianFileName').val(res.data.xiaoshuowenjian)
					}
