					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑读者</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("duzhe/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
