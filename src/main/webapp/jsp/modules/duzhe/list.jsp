...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>读者管理</span></li>
								<li class="breadcrumb-item active"><span>读者列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">读者列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										读者账号
									</label>
									<input type="text" id="duzhezhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#duzhezhanghaoSearch').val() != null && $('#duzhezhanghaoSearch').val() != ''){
				searchForm.duzhezhanghao ="%" +  $('#duzhezhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("duzhe/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				duzhezhanghao : searchForm.duzhezhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("duzhe/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"duzhe");
