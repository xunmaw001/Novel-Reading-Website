				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('goumaixiaoshuo','下载')" @click="onAcrossTap('xiazaixiaoshuo')" type="button" class="layui-btn">
								下载
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`goumaixiaoshuo`);
