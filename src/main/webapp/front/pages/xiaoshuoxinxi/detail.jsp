				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>作者账号：</span>
							<span class="desc">
								{{detail.zuozhezhanghao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>作者姓名：</span>
							<span class="desc">
								{{detail.zuozhexingming}}
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('xiaoshuoxinxi','购买')" @click="onAcrossTap('goumaixiaoshuo')" type="button" class="layui-btn">
								购买
							</button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`xiaoshuoxinxi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.xiaoshuomingcheng;
																																																												// 轮播图片
					vue.swiperList = vue.detail.xiaoshuofengmian ? vue.detail.xiaoshuofengmian.split(",") : [];
																																																																											var swiperItemHtml = '';
