        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="xiaoshuofenlei" id="xiaoshuofenlei" placeholder="小说分类" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('xiaoshuoxinxi','新增')" @click="jump('../xiaoshuoxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../xiaoshuoxinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.xiaoshuofengmian?item.xiaoshuofengmian.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.xiaoshuomingcheng}}</h5>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xiaoshuomingcheng').val()) {
          param['xiaoshuomingcheng'] = jquery('#xiaoshuomingcheng').val() ? '%' + jquery('#xiaoshuomingcheng').val() + '%' : '';
        }  
        if (jquery('#xiaoshuofenlei').val()) {
          param['xiaoshuofenlei'] = jquery('#xiaoshuofenlei').val() ? '%' + jquery('#xiaoshuofenlei').val() + '%' : '';
        }  
        if (jquery('#zuozhezhanghao').val()) {
          param['zuozhezhanghao'] = jquery('#zuozhezhanghao').val() ? '%' + jquery('#zuozhezhanghao').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('xiaoshuoxinxi/list', 'get', param, function(res) {
