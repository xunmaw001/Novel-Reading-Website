        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('duzhe','新增')" @click="jump('../duzhe/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../duzhe/detail.jsp?id='+item.id">
                <div class="posi-img">
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#duzhezhanghao').val()) {
          param['duzhezhanghao'] = jquery('#duzhezhanghao').val() ? '%' + jquery('#duzhezhanghao').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('duzhe/list', 'get', param, function(res) {
