...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in xiaoshuoxinxiRecommend" v-bind:key="index">
                <a target="_self" :href="'../xiaoshuoxinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.xiaoshuofengmian?item.xiaoshuofengmian.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in xiaoshuoxinxiList" v-bind:key="index">
                <a target="_self" :href="'../xiaoshuoxinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.xiaoshuofengmian?item.xiaoshuofengmian.split(',')[0]:''" width="385" height="220" />
                  </div>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`xiaoshuoxinxi/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.xiaoshuoxinxiRecommend = res.data.list;
      });

      http.request(`xiaoshuoxinxi/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.xiaoshuoxinxiList = res.data.list;
      });
    });
  </script>
</body>
