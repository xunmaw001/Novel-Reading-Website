				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="chongzhijine" id="chongzhijine" placeholder="充值金额" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">充值日期</label>
							<div class="layui-input-block">
								<input type="text" name="chongzhiriqi" id="chongzhiriqi" placeholder="充值日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
